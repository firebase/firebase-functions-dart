...
void runIdentityTests(
  ...
  group('Identity Platform (Auth Blocking)', skip: 'Auth emulator only supports beforeCreate/beforeSignIn', () {
    ...
    group('beforeUserCreated', () {
      ...
      test('blocking function can block user creation', () async {
        ...
        expect(
          dartRuntimeLogged,
          isTrue,
          reason: 'Dart runtime should have processed and blocked before-create request',
        );
      });
